...
import { CreateAlarmLabelProps } from './common/types';

const id = 'ds-clock-alarm-create-alarm-label';

const CreateAlarmLabel: FC<CreateAlarmLabelProps> = ({ control }) => {
	return (
		<Controller
			control={control}
			name='label'
...
export default CreateAlarmLabel;
