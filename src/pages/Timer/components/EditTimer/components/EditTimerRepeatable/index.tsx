...
import { EditTimerRepeatableProps } from './common/types';

const EditTimerRepeatable: FC<EditTimerRepeatableProps> = ({ control, setValue }) => {
	return (
		<Controller
			control={control}
			name='isRepeatable'
...
export default EditTimerRepeatable;
