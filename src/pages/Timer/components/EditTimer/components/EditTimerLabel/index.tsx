...
import { EditTimerLabelProps } from './common/types';

const id = 'ds-clock-timer-edit-timer-label';

const EditTimerLabel: FC<EditTimerLabelProps> = ({ control }) => {
	return (
		<Controller
			control={control}
			name='label'
