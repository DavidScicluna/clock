...
import { CreateTimerLabelProps } from './common/types';

const id = 'ds-clock-timer-create-timer-label';

const CreateTimerLabel: FC<CreateTimerLabelProps> = ({ control }) => {
	return (
		<Controller
			control={control}
			name='label'
...
export default CreateTimerLabel;
