...
import { CreateTimerTimePickerProps } from './common/types';

const CreateTimerTimePicker: FC<CreateTimerTimePickerProps> = ({ control, setValue }) => {
...
export default CreateTimerTimePicker;
